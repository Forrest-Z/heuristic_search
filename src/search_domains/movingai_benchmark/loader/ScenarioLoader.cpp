//This file is copied from https://github.com/nathansttt/movingai/blob/master/utils/ScenarioLoader.cpp
...
std::ostream &operator<<(std::ostream &stream, Experiment const& experiment)
{
    ...
    stream  << std::fixed << std::setprecision(3)
            ...
            << std::setw(width) << std::right << experiment.GetStartX() << " "
            << std::setw(width) << std::right << experiment.GetStartY() << " "
            << std::setw(width) << std::right << experiment.GetGoalX() << " "
            << std::setw(width) << std::right << experiment.GetGoalY() << " "
            << std::setw(width) << std::right << experiment.GetBucket() << " "
            << std::setw(width) << std::right << experiment.GetDistance();
