...
typedef heuristic_search::SearchAlgorithmBegin<            
        ...
        heuristic_search::SearchAlgorithmEnd<TestDomain> > > > > > > >   DStarLiteOptimizedTestAlgorithm_t;
    
TEST(test_DStarLiteOptimized, search_reinitialize_start)
{        
    TestDomain domain;
    
    DStarLiteOptimizedTestAlgorithm_t::Algorithm_t algorithm(domain, 
...
TEST(test_DStarLiteOptimized, search_reinitialize_start_in_range)
{        
    TestDomain domain;
...
TEST(test_DStarLiteOptimized, search_cost_increase)
{       
    typedef DStarLiteOptimizedTestAlgorithm_t::Algorithm_t::Node_t Node_t;
    ...
    EXPECT_EQ(TestDomain::costMax(), node_0->g);
...
TEST(test_DStarLiteOptimized, search_cost_decrease)
{       
    typedef DStarLiteOptimizedTestAlgorithm_t::Algorithm_t::Node_t Node_t;
