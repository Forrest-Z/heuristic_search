...
typedef heuristic_search::SearchAlgorithmBegin<            
        ...
        heuristic_search::SearchAlgorithmEnd<movingai_benchmark::Domain> > > > > > > >   DStarLiteHog2Algorithm_t;
    
TEST(test_DStarLiteHog2, search_reinitialize_start)
{
    ...
    DStarLiteHog2Algorithm_t::Algorithm_t algorithm(domain, 
